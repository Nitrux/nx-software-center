...
TaskDownloadAppImageController::TaskDownloadAppImageController(QString appImageId, QString appImageReleaseId, QList<Repository *> repositories, DownloadManager *downloadManager, Registry *registry, QObject *parent): TaskController(parent)
{
    m_interactor = new DownloadAppImageReleaseInteractor(appImageId, appImageReleaseId,
                                                                   repositories,
                                                                   downloadManager,
                                                                   registry,
                                                                   this);
...
void TaskDownloadAppImageController::progress(const int progress, const int total, const QString statusMessage)
{
